...
LEFT JOIN user ON  blog.auther_id=user.userid WHERE blog_title like '%$value%' or blog_body like '%$value%' ORDER BY blog.publish_date DESC limit $offset,$limit";
$run=mysqli_query($conn,$sql);
$row=mysqli_num_rows($run);
?>
<div class="container mt-2">
<h3>Search Result For: <span class="text-primary"><?php echo $value; ?></span></h3>
	<div class="row">
		<div class="col-lg-8">
            <?php 
            if($row>0){
            ...
            <?php
                ...
                {
                    echo "<h5 class='text-danger'> No Record Fond </h5>";
                }
                ?>
<!-- pagination -->
<?php
